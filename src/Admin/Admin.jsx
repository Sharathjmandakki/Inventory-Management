...
export default function Admin() {
  ...
  useEffect(() => {
    function data() {
      if (user === undefined || user === null || user === "" || as === "User") {
        navgate("/login", { replace: true })
      } else {
        document.title = "Inventory  | Manager | " + user;
      }
    }
    data()
  }, [])
      ...
      <nav class="bg-white border-gray-200 dark:bg-gray-900 min-w-80">
        <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="" class="flex items-center space-x-3 rtl:space-x-reverse" onClick={home}>
            <span class="flex flex-wrap self-center text-2xl font-semibold dark:text-white">Inventory | Manager</span>
          </Link>
          ...
          <div class={menu ? "hidden w-full md:block md:w-auto" : "w-full md:block md:w-auto"} id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              {/* <li>
                <Link to="cart" class={(pg === 2) ? "block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" : "block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"} onClick={addOrder}>Cart</Link>
              </li> */}
              <li>
              ...
              <li>
                <Link to="messages" class={(pg === 3) ? "block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" : "block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"} onClick={Messages}>Messages</Link>
              </li>
              <li>
                <Link to="users" class={(pg === 4) ? "block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" : "block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"} onClick={Users}>Users</Link>
              </li>
              <l1>
